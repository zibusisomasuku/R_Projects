...
claims_data16 = ldply(claims_16, drop_na, ncol = 1)
...
claims_data17 = ldply(claims_17, drop_na, ncol = 1)
...
claims_data18 = ldply(claims_18, drop_na, ncol = 1)
...
claims_data19 = ldply(claims_19, drop_na, ncol = 1)
...
au_data = drop_na(claims_au_n, ncol = 1)
